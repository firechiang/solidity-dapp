...
contract TokenToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function TokenToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
